...
export class AppComponent implements OnInit, AfterViewInit {
  ...
  constructor(private _zone: NgZone, private commonService: CommonService) {}
  ...
  ngAfterViewInit() {
    gapi.load('auth2', () => {
      this.auth2 = gapi.auth2.init({
        client_id: '397011996209-sfnclnnlnl2bigrmlo5li9g45v66kh08.apps.googleusercontent.com',
